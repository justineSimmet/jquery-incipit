...
(function($, undefined){
	...
	var _fr = {
		defaultError : {
		content : "Je descendais le dernier coteau du Canigou, et, bien que le soleil fût déjà couché, je distinguais dans la plaine les maisons de la petite ville d’Ille, vers laquelle je me dirigeais.",
			author : "Prosper Mérimée",
			origin : "La Vénus d'Ille",
		},
